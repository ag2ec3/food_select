        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit} noValidate>
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 font-mono text-zinc-900 shadow-sm outline-none transition focus:border-zinc-500 focus:ring-2 focus:ring-zinc-500/20"
